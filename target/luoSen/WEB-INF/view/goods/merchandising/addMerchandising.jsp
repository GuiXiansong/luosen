...
<div class="container">
    <form id="contact" action="<%=basePath%>/merchandising/addMerchandisingInfo.do" method="post">
        <h3>添加商品采购信息</h3>
        <h4>我们将尽快解决您的申请，请耐心等待</h4>
        <fieldset>
            <input placeholder="编号" type="hidden" name="id" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
        ...
        <fieldset>
            <input placeholder="销售数量/重量" type="text" name="count" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
            <input placeholder="销售额" type="text" name="sales" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
            <input placeholder="销售日期" type="date" style="width: 100%;height: 40px; vertical-align: middle; line-height: 40px;" name="salesDate" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
