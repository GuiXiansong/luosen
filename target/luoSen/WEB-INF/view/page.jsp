...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo" style="font-size: 17px;"><strong>分店管理系统</strong></div>
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:;" style="text-decoration: none;">
                    <img src="<%=basePath%>/static/img/touxiang.jpeg" class="layui-nav-img">
...
<%--                    <dd><a href="" style="text-decoration: none;"><strong>基本资料</strong></a></dd>--%>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item">
                    <a style="text-decoration: none" href="javascript:;"
                       onclick="javascript:toInventoryInfoPage()"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库存信息 </strong></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" onclick="toInventoryInfoPage()"
                               style="text-decoration: none"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库存盘点</strong></a></dd>
                        <dd><a href="javascript:;" onclick="toWarehousing()"
                               style="text-decoration: none"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;入库信息</strong></a></dd>
                        <dd><a href="javascript:;" onclick="toOutOfStock()"
                               style="text-decoration: none"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;出库信息</strong></a></dd>
                    </dl>
                </li>
                </dl>
                </li>
                ...
                <li class="layui-nav-item">
                    <a style="text-decoration: none;" href="javascript:;"
                       onclick="javascript: toCountInStockInfoPage;"><strong><span class="fa fa-leaf fa-fw"></span>&nbsp;&nbsp;&nbsp;统计</strong></a>
                    <dl class="layui-nav-child">
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        <strong>© 分店管理系统&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;---->&nbsp;Create by 皮皮桂</strong>
...
<script type="text/javascript">
    ...
    function toInventoryInfoPage() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/stockInfo/toInventoryInfoPage.do\" width=\"100%\" height=\"100%\"></object>";
    }

    function toWarehousing() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/stock/toWarehousing.do\" width=\"100%\" height=\"100%\"></object>";
    }

    function toOutOfStock() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/stock/toOutOfStock.do\" width=\"100%\" height=\"100%\"></object>";
    }
