...
<div class="container">
    <div class="text-center">
        ...
        <br/>
        <br/>
        <h1 style="color:#009688">错误信息<br/>
            <br>
            ${messagePasswordChange}<br>
            ${requestScope.get("messagePasswordChange")}
        </h1>
        <hr/>
        <br/>
        <h3 style="color:#FF5722">${requestScope.get("messagePasswordChange")}</h3>
        <br/>
        <br/>
        <button class="btn btn-primary btn-lg" type="button"><a href="<%=basePath%>/user/toPasswordChangePage.do" style="text-decoration: none;color:white;">点击我返回密码修改页面</a></button>
    </div>
</div>
</body>
</html>
