...
<div class="container">
    <form id="contact" action="<%=basePath%>/stock/addStockInfo.do" method="post">
        <h3>增加员工信息</h3>
        ...
        <fieldset>
            <input placeholder="库存总数量/重量" type="text" name="sum" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
            <input placeholder="日期" type="date" style="width: 100%;height: 40px; vertical-align: middle; line-height: 40px;" name="stockDate" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
