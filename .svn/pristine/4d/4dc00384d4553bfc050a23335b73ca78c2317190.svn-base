...
public class StockServiceImpl implements StockService {
    ...
    @Override
    public PageBean<Stock> toWarehousing(int currentPage, Long storeId) {
        HashMap<String,Object> map=new HashMap<String, Object>();
        PageBean<Stock> pageBean=new PageBean<Stock>();
        ...
        //封装总记录数
        int totalCount=stockDao.toWarehousingSelectCount(storeId);
        pageBean.setTotalCount(totalCount);
        ...
        //封装每页显示的数据
        List<Stock> list=stockDao.toWarehousingFindByPage(map);
        pageBean.setLists(list);
    ...
    @Override
    public PageBean<Stock> toOutOfStock(int currentPage, Long storeId) {
        HashMap<String,Object> map=new HashMap<String, Object>();
        PageBean<Stock> pageBean=new PageBean<Stock>();
        ...
        //封装总记录数
        int totalCount=stockDao.toOutOfStockSelectCount(storeId);
        pageBean.setTotalCount(totalCount);
        ...
        //封装每页显示的数据
        List<Stock> list=stockDao.toOutOfStockFindByPage(map);
        pageBean.setLists(list);
    ...
    @Override
    public void addOutOfStock(Stock stock) {
        stockDao.addOutOfStock(stock);
    }

    @Override
    public Double findAllStockInfoByStoreIdAndGoodsId(Long storeId, Long goodsId, String yearMonth) {
        return stockDao.findAllStockInfoByStoreIdAndGoodsId(storeId,goodsId,yearMonth);
    }

    @Override
    public Double countAllStockInfoSumByStoreIdAndGoodsId(Long storeId, Long goodsId, String yearMonth) {
        return stockDao.countAllStockInfoSumByStoreIdAndGoodsId(storeId,goodsId,yearMonth);
    }
