...
<head>
    ...
    <style type="text/css">
        .header{
            background-image: url("<%=basePath%>/static/img/fenjing2.jpeg");
            background-size: 100%;
            height: 200px;
        }
        #code{
...
<div class="container">
    <div id="content">
        <h2 class="text-nowrap" style="color: #393D49;text-align:center;padding-top:10%;font-family: Menlo">罗森连锁店管理系统</h2>
            ...
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="username" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="请输入用户名"/>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" name="password" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="请输入密码"/>
                    </div>
                </div>
                <br/>
                <br/>
